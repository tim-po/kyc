...
const IdentityInformation = (props: IdentityInformationPropType) => {
  ...
  const isLocalStorageValid = localStorageData
    && localStorageData.firstName
    && localStorageData.lastName
    && localStorageData.middleName
    && localStorageData.nationality
  ...
  useEffect(() => {
    ...
    setLocalStorageData(JSON.parse(`${identityInformation}`))
  ...
  }, [isFirstRender, localStorageData.firstName, localStorageData.middleName, localStorageData.lastName, localStorageData.nationality])
